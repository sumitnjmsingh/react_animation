...
const Footer = () => {
  return (
    <div className='flex flex-wrap  w-full h-screen bg-zinc-900 text-white  lg:p-20 p-10'>
        <div className='w-1/2 h-full flex flex-col justify-between'>
        <div className='headings'>
            <h1 className='text-[7vw] font-semibold uppercase leading-none lg:-mb-5'>EYE-</h1>
            <h1 className='text-[7vw] font-semibold uppercase leading-none lg:-mb-5'>Opening</h1>
        </div>
        ...
        <div className='w-1/2'>
             ...
             <div className='flex w-full  lg:text-xl text-[15px]'>
                ...
                <div className='w-1/2  justify-center flex flex-col items-center gap-5 mt-10 underline'>
                   <a>Instagram</a>
                   <a>Facebook</a>
                   <a>Mail To</a>
                   <a>Twiter</a>
